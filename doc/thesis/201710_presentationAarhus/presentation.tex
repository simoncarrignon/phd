...
\begin{frame}{``Neutral'' model }
	...
	\item<+-> negligible economic cost 
	    ...
	    \end{itemize}
	\item<+-> no preference (prestige\dots)
    \end{itemize}
...
\begin{frame}{Specification of the model}
    \textcolor{UPF}{\textbf{1.}\Huge}  Integrate historical knowledge: \\
...
\begin{frame}{Individual vs Social learning}
	...
	Agents as markets of urban settlements:
    \begin{itemize}
	...
	\item<4-> \textbf{social} learning (cultural transfer): \\
