...
\bibpunct{[}{]}{,}{a}{,}{,}
%%Repris du
%%Revisite du talk fait à EPHE avec Elisabetta avec ajout des heatmaps et retours des rapports.
%%Revisite de janvier 2012, revu des heatmaps en gros :
...
\begin{frame}{Speciation}
	\begin{columns}
		...
		\column{.5\textwidth}
			\begin{figure}
				\subfigure[Allopatric speciation]{\includegraphics[width=0.3\textwidth]{../20110616-SoutenanceMemoire/images/SpeciationAl}}	\label{figa:specAl} 
				\hspace{.2cm}
				\subfigure[Sympatric speciation]{
					\includegraphics[width=0.3\textwidth]{../20110616-SoutenanceMemoire/images/SpeciationSy}
				}	\label{figa:specSy} 
			% \caption{Diff. cas}
			\end{figure}
	\end{columns}
...
\begin{table}[H]
	 ...
	 \begin{tabular}{ccc} 
		&ENV1&ENV2\\ 
	        \includegraphics[width=\imgSize]{images/qualitative_distribution}& \includegraphics[width=\imgSize]{../images/5StaticEnv/alive_staticEnv1}& \includegraphics[width=\imgSize]{../images/5StaticEnv/alive_staticEnv2}\\
		 \includegraphics[width=\imgSize]{../images/5StaticEnv/alive_staticEnv0}& \includegraphics[width=\imgSize]{../images/5StaticEnv/alive_staticEnv3}& \includegraphics[width=\imgSize]{../images/5StaticEnv/alive_staticEnv4}\\
		 ENV0&ENV3&ENV4 \newline 
	 \end{tabular} 
 \end{table} % 	
% \end{columns}
...
\includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot29_staticEnv1}& \includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot29Static_staticEnv1}\\ \end{tabular} \end{table} \end{frame} \begin{frame}{ENV2} \begin{table}[H] \centering \begin{tabular}{cc} \includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot22_staticEnv2}& \includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot22Static_staticEnv2}\\ \includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot92_staticEnv2}& \includegraphics[width=\imgSize]{../images/5StaticEnv/Gplot92Static_staticEnv2}\\
		\end{tabular}
	\end{table}
\end{frame}
...
\begin{frame}{ENV 1 \& ENV 2}
	...
	\centering
		...
		\newline
		\includegraphics[width=\imgSize]{../images/5StaticEnv/medianAliveTwoHM_env1}&\includegraphics[width=\imgSize]{../images/5StaticEnv/medianAliveTwoHM_env2}\\
...
\begin{frame}{ENV3 \& ENV4}
	\begin{table}[H]
		...
		\includegraphics[width=\imgSize]{../images/5StaticEnv/medianAliveTwoHM_env3}&
		\includegraphics[width=\imgSize]{../images/5StaticEnv/medianAliveTwoHM_env4}\\
...
\begin{frame}{ENV 0}
	...
	\begin{table}[H]
		\begin{tabular}{cc}
			...
			\includegraphics[width=\imgSize]{../images/5StaticEnv/medianAliveTwoHM_env0}\\
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LES RATIOS : (meme slides que précédemmebt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{ENV 1 \& ENV 2: Resources harvested wrt. availability}
	...
	\centering
		...
		\includegraphics[width=2cm]{../images/5StaticEnv/environments/staticEnv1}&\includegraphics[width=2cm]{../images/5StaticEnv/environments/staticEnv2}\\
		\newline
		\includegraphics[width=\imgSize]{../images/5StaticEnv/medianRatioHM_env1}&\includegraphics[width=\imgSize]{../images/5StaticEnv/medianRatioHM_env2}\\
\includegraphics[width=2cm]{../images/5StaticEnv/AliveHM_env1}&\includegraphics[width=2cm]{../images/5StaticEnv/AliveHM_env2}\\
		\end{tabular}
	\end{table}
\end{frame}
