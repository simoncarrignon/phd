...
\begin{frame}{Introduction}
    ...
    %How I started from the will to understand \emph{computer} and \emph{cells}, ending to study \emph{history} using a \emph{church} powered by \emph{complex system} in a school of \emph{biomedecine}
\end{frame}
