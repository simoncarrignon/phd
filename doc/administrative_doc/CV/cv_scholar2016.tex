...
\section{Interests}
\cvitem{}{Among other things, I used to have a lot of associative activities. Mostly activities which go around music but also a bunch of works about sciences communication. I like reading, travel around the world and from time to time, dive into the Linux CLI.}
