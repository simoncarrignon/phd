...
\email{sc@elisya.org}                          % optional, remove the line if not wanted
...
\cventry{Jan. 2010--Mar. 2012}{Research engineer }{LUTIN-Université Paris 8}{Paris, France}{}{1 week to 3 months short contracts: modeling, data processing \& statistical analysis. Some selected outcome:
\begin{itemize}
	\item ACACIA Coop: a Netlogo program to explore the worth of altruistic behaviors in swarm of autonomous agent~(\href{https://github.com/simoncarrignon/acacia-coop}{@git})
	\item Pedestrian: a Netlogo program to test agent based pedestrian models on real map~(\href{https://github.com/simoncarrignon/pedestrian}{@git}).
\end{itemize}
}%
...
\newline{}C2I course -- teaching of office tools (open source version of Word,Excel,PPT) \& general knowledge of computers (software/hardware/network). }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{.2cm}
\subsection{Research Stay}
\cventry{June 2018}{Visiting Scholar}{NIMBIOS-University of Tennessee}{Knoxville, USA}{}{One month visiting scholar with professor Alex Bentley. Development of models of spread of information on online social media. Validation of the models against datasets using Approximate Bayesian Computation. R-package and vignette available:~\href{https://framagit.org/sc/twitter-spread}{@git}}
\cventry{May 2010}{Visiting Student}{LORIA}{Nancy, France}{}{One week stay in the team of Olivier Simonin. Work on the asservisment of Khepera III robot + learning and adapting a system of a greyscale color floor system to guide the robot.}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{.2cm}
\subsection{Internship}
\cventry{Sept. 2009--Jan. 2011}{Human Heuristic \& Autonomous Robot}{Supervisor: E. Zibetti (CHArt-Univ. P8)}{Paris, France}{}{Development of a Java API to control a Khepera III robot using autonomous controller build from Human Heuristics. }
\cventry{May 2009--Aug. 2009}{Controler for physiological experiments}{Supervisor: A. Green~(Dept. de Physio.-UdeM)}{Montréal, Canada}{}{Graphic interface \& communication's tools to control and synchronize experimental setup designed for physiological studies on monkey's nervous system.}
\cventry{May 2008--Aug. 2008}{Phylogenetic, Bacteries \& LGT }{Supervisor: V. Daubin~(LBBE-UCBL)}{Lyon, France}{}{C++ implementation of an algorithm used to adjust the species tree with the genetic tree including duplication and Lateral Gene Transfer.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{.2cm}
...
\cventry{September 2012}{The Evolution and Function of Consciousness.}{Summer Institute in Cognitive Sciences}{Montreal, Canada}{}{Week of lectures on the Evolution and Function of consciousness. When, where, how and why --since the origin of life on Earth about 4 billion years ago-- did organisms' input/output functions become conscious input/output functions? What is the causal role of consciousness?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{.2cm}
\subsection{Organisation and Edition}
\cventry{Assistant Editor}{Since November 2017}{Special Issue: Evolution of Cultural Complexity}{Adaptive Behavior}{}{Assistant Editor of a special issue ``Evolution of Cultural Complexity'' in the journal of Adaptive Behavior. Expected publication date: September 2019. }
\cventry{Website: https://ccs18.bsc.es}{September 2018}{Evolution of Cultural Complexity III }{Thessaloniki, Greece }{}{Organisation and chair of the satellite ``Evolution of Cultural Complexity'' at the 2018 Conference on Complex System. Invited speakers: Peter Turchin \& Anne Kandler }
\cventry{Website: https://ccs17.bsc.es}{September 2017}{Evolution of Cultural Complexity II}{Cancun, Mexico }{}{Organisation and chair of the satellite ``Evolution of Cultural Complexity'' at the 2017 Conference on Complex System. Invited speakers: Sergi Valverde, Tom Froese \& Alex Bentley }
\cventry{Website: http://laremi.net}{Avril 2013}{Darwin as a Conductor}{Lyon, France}{}{Organisation and chair of a 3-days conference on the use of Darwinian theories to understand changes in music. Invited speakers:~Olivier Morin, Mathieu Charbonneau \& Steven Jan}

\section{Grant \& Fundings}
\cvitemwithcomment{Severo Ochoa Mobility Grant (2018)}{Accommodation \& travel for 1-month visiting research}{2\,000€}
\cvitemwithcomment{NECSI Winter School Scholarship (2018)}{Inscription fees for NECSI winter school}{\$1\,300}
\cvitemwithcomment{DACAS Early Career Bursary (2016)}{Accommodation \& travel for DACAS Workshop}{£350}
\cvitemwithcomment{ENS Lyon - Junior Lab (2011-2013)}{Funding for meetings, experiments and conferences}{3\,000€}
...
\cvitem{OS}{Linux (Ubuntu/Debian/rasbian end \& admin user), FreeBSD, Windows XP, Seven, Vista. Grid/Supercomputer usage.}{}{}
...
\cvitem{Git}{Personal repositories \href{https://github.com/simoncarrignon/}{@github.com} \& \href{https://framagit.org/sc/}{@framagit (gitlab)}}{}{}
