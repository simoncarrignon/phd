...
\cventry{Jan. 2010--Mar. 2012}{Research engineer }{LUTIN-Université Paris 8}{Paris, France}{}{1 week to 3 months contracts during which I helped researchers in data processing \& statistical analysis. Among various output of those different project:
\begin{itemize}
...
\newline{}C2I classes-- teaching of the fundamentals to handle office tools and understand computers. }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{.2cm}
...
\cvitemwithcomment{Spanish}{Good}{Daily practice, work interactions}

\section{Technical skills}
\cvitem{OS}{Linux (Ubuntu/Debian end \& admin user), Windows XP, Seven, Vista. Grid/Supercomputer user.}{}{}
\cvitem{Publishing}{\LaTeX / \LuaTeX,Open Office \& Microsoft Office Writers.}{}{}
%%\cvitem{Databases}{Mysql,Oracle (SQL).}{}{}
\cvitem{Programming Languages}{C/C++, R, Bash, Python, Php, Java.}{}{}
...
\section{Interests}
\cvitem{}{Among other things, I used to have a lot of associative activities mostly revolving around music and sciences communication and popularization. I like reading, traveling around the world and dive into the Linux CLI.}
