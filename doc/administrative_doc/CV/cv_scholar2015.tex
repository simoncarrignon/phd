...
\pagestyle{empty}
\section{Education}
\cventry{since jan. 2015}{PhD Student in Biomedicine}{Universitat Pompeu Fabra}{Barcelona, Spain}{}{Study the Interaction between Culture and Economy using Computer Modelisation and Evolutionary Theory with the evolution of the Roman Empire Economy as a case study. Co-direction between Barcelona Supercomputing Center and Univ. Pompeu Fabra Complex System Lab.}
...
\bibliography{../../biblio/bib/SimonCarrignon.bib}                   % 'publications' is the name of a BibTeX file
