...
\begin{itemize}
    \item  \bibentry{gaudiello2010representations}  
    ...
    \item  \bibentry{bredeche2017benefitsofproportionateselectioninembodiedevolutionacasestudywithbehaviouralspecialization}  
\end{itemize}
