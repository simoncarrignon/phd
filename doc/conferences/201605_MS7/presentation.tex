...
\begin{frame}{Formal Description \& Comparison}
	...
	\begin{center}
	    ...
	    \only<1>{		    \includegraphics[height=6cm]{images/looselyMarket.png}\\ Roman Bazaar}
...
\begin{frame}{Hypothesis Generation}
    Conceptual Model (Barandian 2006) used as Opaque thought experiement (Di Paolo 2000):\\
    \vfill
    \begin{itemize}
	\item <2-> Thought Experiment:\\
	    \uncover<3->{\small \hspace{.5cm} Higher degree of freedom than experimental methods ()}
	...
	\item <4-> Experiment: \\
	    ...
	    \vfill
	\item <6-> Opacity: \\
	    \uncover<7->{\small \hspace{.5cm}  Need to be ``experimentally'' explored}
    \end{itemize}
