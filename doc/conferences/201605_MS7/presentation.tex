...
\begin{frame}{Evolutionary biology toolkit}
    ...
    \vfill
    	\begin{itemize}
	    \item<2-> Computer Simulation to study complex mathematical model
    \vfill
...
\begin{frame}{Computer Simulation}
    \begin{itemize}
	\item<1->  To select competing models ( Bayesian inference \& model selection)
	\item<4-> In systems that focus on interactions (Evolutionary Ecology, EvoDevo\dots)
	\item<7-> \dots
    \end{itemize}
...
\begin{frame}{Model Selection analysis}
    ...
    \end{itemize}
    \uncover<3->{Find the best hypothesis.\\}
    \uncover<4->{Use of computer simulation to}
    \begin{enumerate}
	\item<5-> Explore the models
	\item<6-> Quantitative comparaison 
    \end{enumerate}
...
\begin{frame}{Result}
    Approximate Baeysian Computation:
    \uncover<2->{
	\begin{itemize}
	\item Simulate the models
	\item Compare
    \end{itemize}
}
\uncover<3->{
...
\begin{frame}
	...
	\begin{itemize}
		...
		\hspace{1cm}\uncover<2->{and incorporate knowledge from different discipline (network theory, game theory\dots)}
...
\end{frame}
\begin{frame}{Cultural Transmission}
    Explore the model and generate new hypothesis:
    \begin{center}
...
\begin{frame}{Limitations}
	...
	\begin{itemize}
	    \item Opacity,
	    \item Conscious or inconscious assumptions at every level, 
	    \item very heterogenous data \& knowledge, 
