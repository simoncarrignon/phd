...
badd +13 comprendre.tex
badd +38 /usr/share/texlive/texmf-dist/tex/latex/fontspec/fontspec.sty
badd +283 main.log
badd +11 secondpart.tex
badd +4 robotique.tex
badd +1 firstpart.tex
badd +0 thirdpart.tex
...
silent! normal! zE
3,17fold
let s:l = 118 - ((33 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
normal! 0
tabedit secondpart.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal includeexpr=substitute(v:fname,\ '^.\\{-}{\\|}.*',\ '',\ 'g')
setlocal indentexpr=GetTeXIndent()
setlocal indentkeys=0{,0},:,0#,!^F,o,O,e,},],=^s*^s*^s*^s*^s*\\bibitem,=\\item,},],=^s*^s*^s*^s*^s*^s*\\bibitem,=\\item,},],=^s*^s*^s*^s*^s*^s*^s*\\bibitem,=\\item
setlocal noinfercase
setlocal iskeyword=48-57,a-z,A-Z,192-255
setlocal keywordprg=
set linebreak
